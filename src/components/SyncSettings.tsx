...
export function SyncSettings({ isOpen, onClose }: SyncSettingsProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
      <div className="bg-theme-surface rounded-2xl w-full max-w-md">
        <div className="p-6">
          ...
          <div className="space-y-6">
            ...
            <div>
              <label className="flex items-center space-x-3 cursor-pointer">
                <input
                  ...
                  className="w-5 h-5 text-theme-primary border-theme-border rounded focus:ring-blue-500"
                />
                <div>
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-2 border border-theme-border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent disabled:opacity-50 disabled:cursor-not-allowed"
              >
            ...
            <div>
              ...
              <div className="space-y-2">
                <label className="flex items-start space-x-3 cursor-pointer p-3 border border-theme-border rounded-lg hover:bg-theme-secondary transition-colors">
                  <input
                    type="radio"
                    name="sync_direction"
                    value="bidirectional"
                    ...
                    className="mt-1 w-4 h-4 text-theme-primary border-theme-border focus:ring-blue-500"
                  />
            ...
            <div className="flex space-x-3 pt-4">
              <button
                onClick={onClose}
                className="flex-1 px-4 py-2 border border-theme-border text-theme-fg opacity-90 rounded-lg hover:bg-theme-secondary transition-colors"
              >
                Cancel
              </button>
              <button
                onClick={handleSave}
                disabled={saving}
                className="flex-1 px-4 py-2 bg-theme-primary text-white rounded-lg hover:bg-theme-primary transition-colors disabled:opacity-50 flex items-center justify-center space-x-2"
              >
