          ...
          <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 sm:px-4 border border-theme-border rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent text-sm sm:text-base"
            ...
            <div className="space-y-2 sm:space-y-3">
              <label className="flex items-center">
                <input
                  ...
                  className="w-3 h-3 sm:w-4 sm:h-4 text-orange-600 border-theme-border rounded focus:ring-orange-500"
                />
