  ...
  return (
    <div className="h-screen overflow-y-auto pb-20 sm:pb-24">
      ...
      <div className="bg-gradient-to-r from-blue-500 to-green-500 text-white p-4 sm:p-6">
        <div className="flex items-center space-x-4 mb-4">
          ...
          <div>
            ...
            <p className="text-sm sm:text-base text-blue-100">{user?.email}</p>
          </div>
          <button
      ...
      <div className="p-4 sm:p-6">
        ...
        <div className="mb-4 sm:mb-6 bg-gradient-to-r from-blue-50 to-cyan-50 border border-blue-200 rounded-xl p-3 sm:p-4">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      {item.showAddButton && (
                        <button
                          ...
                          className="w-6 h-6 sm:w-8 sm:h-8 bg-blue-500 text-white rounded-full flex items-center justify-center hover:bg-blue-600 transition-colors ml-2"
                        >
                    ...
                    <div className="flex items-center space-x-3 sm:space-x-4">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center space-x-2 sm:space-x-3 mb-1 flex-wrap">
                          ...
                          {member.age && (
                            <span className="px-1.5 py-0.5 sm:px-2 sm:py-1 bg-blue-100 text-blue-700 rounded-full text-xs sm:text-sm font-medium">
                              Age {member.age}
                            </span>
                          )}
                          {member.gender && (
